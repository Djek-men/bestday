...
<?php if ( have_comments() ) : ?>
	...
	<div id="comments"><h3><?php comments_number('<span>Нет</span> Комментариев', '<span>Один</span> Комментарий', '<span>%</span> Комментарии' );?></h3></div>
...
<section id="respond" class="respond-form">
	...
	<div id="comment-form-title"><h3><?php _e( 'Leave A Comment', 'site5framework' ); ?></h3></div>
